...
def load_vectorstore():
    ...
    return FAISS.load_local('tot_wcr_embeddings', embeddings)
...
expander.write("""
     :black[I am an AI assistant for R-Series Wells Completion Reports based on LLMs(Large Language Models).Presently I know about  Basics of Reservoir Engineering. Consider the generated response as starting point to assist in our work.] 
